...
namespace dmb
{
	...
	public:
		...
		void Init(const VLVarModelPtr& objectPtr);
	...
	public:
		...
		vl::Var& setData(const std::string& propId, const vl::VarPtr& value);
		template <typename T>
